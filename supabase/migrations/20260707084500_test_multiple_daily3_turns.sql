-- Test mode: allow several ball handoffs in the same streak on the same day.
-- The frontend still only calls this after a completed Dagens 3. The current-turn check remains.
